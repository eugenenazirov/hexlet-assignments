...
class AppTest {
    ...
    void testReversedSequence() {
        ...
        assertThat(seq.charAt(0)).isEqualTo('o');
        assertThat(seq.charAt(1)).isEqualTo('l');
        assertThat(seq.charAt(2)).isEqualTo('l');
        assertThat(seq.charAt(3)).isEqualTo('e');
        assertThat(seq.charAt(4)).isEqualTo('h');
        assertThat(seq.subSequence(0, 3).toString()).isEqualTo("oll");
        assertThat(seq.subSequence(1, 4).toString()).isEqualTo("lle");
        assertThat(seq.subSequence(2, 5).toString()).isEqualTo("leh");
        assertThat(seq.toString()).isEqualTo("olleh");
    }
    // END
}

...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        Address address4 = new Address("USA", "New York", "1-st street", "5", "1");
        ...
        Address address5 = new Address("USA", "New York", "1-st street", "5", null);
        Map<String, List<String>> result5 = Validator.advancedValidate(address5);
        Map<String, List<String>> expected5 = Map.of(
                "country", List.of("length less than 4")
        );
